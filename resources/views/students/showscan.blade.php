        ...
        <div class="row justify-content-center">
            <div class="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-5">
                <div class="card shadow-sm border-0">
                    <div class="card-header text-white text-center py-4" style="background-color: #2980B9;">
                        <h4 class="mb-1">Student Information</h4>
                    </div>
                    <div class="card-body p-3 p-sm-4">
                        <div class="mb-3">
                            <div class="small text-secondary">Learner Reference Number</div>
                            <div class="fw-semibold text-break">{{ $student->lrn }} </div>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-6 mb-3">
                                ...
                                <div class="fw-semibold text-break">{{ $student->school }}</div>
                            </div>
                            <div class="col-12 col-sm-6 mb-3">
                                <div class="small text-secondary">Grade Level</div>
                                <div class="fw-semibold">{{ $student->grade_level }}</div>
                            </div>
                            <div class="col-12 col-sm-6 mb-3">
                                <div class="small text-secondary">Section</div>
                                <div class="fw-semibold text-break">{{ $student->section }}</div>
                            </div>
                            <div class="col-12 col-sm-6 mb-3">
                            ...
                            <div class="col-12 mb-0">
                                <div class="small text-secondary">Parent / Guardian</div>
                                <div class="fw-semibold text-break">{{ $student->parents_name }}</div>
                            </div>
                        </div>
                    </div>
