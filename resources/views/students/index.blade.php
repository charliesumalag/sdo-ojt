...
<div class="p-4">
    ...
    <div class="d-flex justify-content-between align-items-center border-bottom pb-3">
        ...
        <div>
            <h1 class="fs-3 fw-semibold text-dark">
                Student Records
            </h1>

            <p class="small text-secondary">
                Search and audit the division master list with active school board filters.
            </p>
        </div>
    ...
    <div class="bg-white border rounded mt-4 p-3">
        ...
        <div class="d-flex align-items-center flex-wrap gap-2 mt-3">
            ...
            <span class="badge rounded-pill text-primary border border-primary bg-white">
                School: Rizal High
            </span>
